...
public class HomePage1 {
    ...
    public static WebElement journeyDate(ChromeDriver driver) throws InterruptedException {	
    Actions action = new Actions(driver);
    Thread.sleep(1000);
    WebElement journey = driver.findElement(By.xpath("//table[@class='CalendarMonth_table CalendarMonth_table_1']/tbody/tr[2]/td[3]"));
    action.moveToElement(journey).click().perform();
    return journey;
    }
